...
export default function ActivityComment({ tokenState, comment, userId }) {
  ...
  return (
    <>
      <CommentContainer hasDeleted={hasDeleted}>
        ...
        <ButtonContainer>
          <div>
            <ActivityIconButton color="grey">
              <span class="fas fa-heart"></span> Like {comment.likesNum}
            </ActivityIconButton>
            <ActivityIconButton color="grey">
              <span class="fas fa-comment-alt"></span> Reply {comment.replyNum}
            </ActivityIconButton>
          </div>
